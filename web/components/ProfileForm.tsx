...
const ProfileForm = () => {
  ...
  return (
    <div className="employee-form-container">
      <AppBar className="app-bar" position="static" style={{ backgroundColor: '#FFB6C1' }}>
        <Toolbar className="toolbar" style={{ backgroundColor: '#FFB6C1', height: '80px' }}>
      ...
      <Container maxWidth="xs" style={{ backgroundColor: '#FFF0F5' }}>
        <Paper style={{ padding: 20, marginTop: 80, backgroundColor: '#FFE4E1' }}>
          {!isEditing ? (
            <div>
              ...
              <Button
                variant="contained"
                style={{ marginLeft: 300, backgroundColor: '#FF69B4', color: '#FFFFFF' }}
                onClick={handleEdit}
              >
                Edit
              </Button>
              ...
              {({ isSubmitting, errors, touched }) => (
                <Form>
                  ...
                  <Button
                    ...
                    style={{ marginRight: 10, backgroundColor: '#FF69B4', color: '#FFFFFF', marginTop: '18px' }}
                  >
                    Save
                  </Button>
                  <Button
                    style={{ backgroundColor: '#FF69B4', color: '#FFFFFF', marginTop: '18px' }}
                    variant="contained"
                    onClick={handleEdit}
                  >
                    Cancel
      ...
      <footer className="footer1" style={{ backgroundColor: '#FFB6C1', height: '50px' }}>
